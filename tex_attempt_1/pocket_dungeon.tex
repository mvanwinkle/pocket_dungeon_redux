...
\subsection{Putting it all Together - The Start of a Sample Game}
...
\subsection{Sample Character Generation and Continuing the Sample Game}
...
10AP.
I'm going to choose \ref{spell:MM} as his spell and 2 P(otions) 1 Health
...
The green line is Line of Sight, which obviously fails.
Everyone knows you can’t cast magic missiles around corners, that would just be silly.
So combat goes like this:
\begin{description}

\item[Round 1] – I move one square right, the Kobold moves one
square down towards me.

\item[Round 2] – I unleash my two MMs *flip*5 + 5 +1 (flip, plus my
...
\item[Round 3] – Pew Pew! *flip*3 +5 +1 *flip*2+5 +1 One hit, one
...
\subsection{Weapon and Spell Stats}
...
\begin{quote}
In the eternal words of Leroy Jenkins, ``Let's do this thing!!!''
\end{quote}
...
\item You may not swap spells from your spell book during combat.

\item You can only have one monster in each square around you at a time. In squares farther away, you can clump them together, but you can’t have more
...
\subsection{Using Bonus Points}

For every 5 rooms you have explored, you may add one point onto a new item when you find it. For example: If I open a chest in room 11 and it has a
...
You may swap spells from your spell book, to your equipped spell slots as long as you are out of combat. To learn new spells, you will need to find spell books in treasure chests.

\subsubsection{Fireball}
R2 D4 H0 3AP

\subsubsection{Magic Missile} \namedlabel{spell:MM}{MM}
R5 D1 H1 1AP
...
For a description of these attributes, see \ref{Attributes}.
